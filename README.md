<p align="center">
	<b><i>This is my minitalk project from the 42 cursus</i></b><br>
</p>

<div align="center">
  <img src="https://media.giphy.com/media/XFBDihh1plTO2mFxOp/giphy.gif" alt="animated" />
</div>

## 🗣️ About

> _In this project, I developed a data exchange program using UNIX signals, which required me to implement error handling and memory management techniques to ensure the program ran smoothly and efficiently. Throughout the development process, I prioritized stability and reliability, ensuring that the program never quit unexpectedly or suffered from memory leaks. Additionally, I utilized a global variable, but only where it was necessary and fully justified, demonstrating my ability to make strategic decisions in programming projects.
...
- [`ft_printf`](https://github.com/ogorfti/ft_printf) and any equivalent YOU coded
